...
export default function Review() {
  ...
  return (
    <>
        <section className='bg-red-300 w-screen h-[fit-content] py-16 flex flex-col justify-center items-center' >
            <div id={data[content].id} className='w-[80%] text-sm text-white text-center tracking-widest leading-[30px] '>
                {data[content].text}
            </div>
            <div className='mt-16'>
    ...
    <div className='text-center tracking-widest py-10 '>
        <h1 className='text-2xl font-light'>
            FLEXIBLE PAYMENT
        </h1>
        <p className='mt-8 text-[11px] tracking-widest leading-[20px]  px-2 '>
